export default function HowToPage() {
  const steps = [
    ...
    { title: "Upload Files", description: "Drag and drop your files into the yellow box or click to browse your computer." },
    { title: "Review & Reorder", description: "If you uploaded multiple images, you can use the arrows to set the pattern for the final PDF." },
